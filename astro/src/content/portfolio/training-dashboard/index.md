...
summary: Interactive React.js dashboard for personal fitness data visualization and analysis
tags:
  - Visualization
  - React
  - Fitness
...
links:
  - name: Live Demo
    url: https://run-training-activities.netlify.app
---
...
[**View Live Dashboard →**](https://run-training-activities.netlify.app)
...
The dashboard tracks personal training progress, revealing patterns in:
...
Too often, personal health data is locked in proprietary apps. This project advocates for apps offering data export in standardized formats, individual control over personal data, informed decision-making through accessible analytics, and independence from vendor lock-in.
