...
But fitness doesn't work on weekly cycles. Your body adapts over months, not days.

Individual run metrics mean nothing without seeing the bigger picture over time. Context matters more than numbers.

## What I Wanted

I started following a structured training program ([Tactic Method](https://tacticmethod.com) with coach Alex Parker). Run-walk intervals. Progressive distance. Specific heart rate targets.
...
And I wanted to own my data. Not pay for premium features to see insights about my own body.
...
[Include screenshot: Before/after trend lines comparison]
...
Apps want you to check daily. [Research indicates](https://www.thelancet.com/journals/landig/article/PIIS2589-7500(24)00139-0/fulltext) that fitness trackers work best when users focus on long-term benefits rather than daily notifications.
...
Yes, there's technical setup. But if you're reading this, you're curious enough to figure it out. And if you get stuck, I'm here to help.
